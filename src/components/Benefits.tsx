...
const colorPalette = [
  { bgColor: "bg-healthco-yellow/10", accentColor: "bg-healthco-yellow" },
  { bgColor: "bg-healthco-blue/10", accentColor: "bg-healthco-blue" },
  { bgColor: "bg-healthco-green/10", accentColor: "bg-healthco-green" },
];
...
export default function Benefits({ data }: { data?: BenefitData[] | null }) {
  ...
  return (
    <section className="py-20 lg:py-28 bg-healthco-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <p className="text-healthco-blue font-semibold text-sm uppercase tracking-wider mb-3">
            Why HealthCo
          </p>
          <h2 className="text-3xl sm:text-4xl font-bold text-healthco-dark mb-4">
            Our members love us
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Here are a few reasons why people choose HealthCo.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 text-healthco-dark font-semibold hover:gap-3 transition-all"
                >

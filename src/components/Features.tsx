      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-healthco-dark mb-4">
            Get started with HealthCo
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            New to HealthCo? Here are three things you can do right now.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature) => {
            ...
            const color = feature.color ?? "bg-healthco-blue";
            return (
              <div
              ...
              >
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 text-healthco-blue font-semibold group-hover:gap-3 transition-all"
                >
                  {feature.linkText}
